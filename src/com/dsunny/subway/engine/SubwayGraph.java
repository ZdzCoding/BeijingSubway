...
public class SubwayGraph {
	...
	public void printGraph() {
		...
		for (StartStation ss : lstStartStation) {
			...
			for (EndStation es : ss.lstEndStation) {
				sb.append("(").append(es.sid).append(",").append(es.meters)
						.append(")->");
			}
			sb.append("\n");
		}
	 ...
	 *            边的权值(起始节点到终止节点的距离)
	 */
	public void addDoubleEdges(String startSid, String endSid, String lid,
			int meters) {
	...
	public TransPathSummary[] getTransPathSummary(String startSid, String endSid) {
		...
		Logger.d(TAG, arrTps == null ? "" : arrTps.toString());
		return arrTps;
	}
}
